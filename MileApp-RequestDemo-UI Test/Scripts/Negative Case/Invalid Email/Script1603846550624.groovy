...
WebUI.verifyElementPresent(findTestObject('Page_Mileapp  Request Demo/p_The email field is required'), 50)

WebUI.delay(1)

WebUI.setText(findTestObject('Page_Mileapp  Request Demo/input_Email_email'), 'Test')
