...
WebUI.verifyElementPresent(findTestObject('Page_Mileapp  Request Demo/p_The phone field is required'), 50)

WebUI.delay(1)

WebUI.setText(findTestObject('Page_Mileapp  Request Demo/input_Phone number_phone'), 'Test123123')

WebUI.delay(1)

WebUI.click(findTestObject('Page_Mileapp  Request Demo/button_Request Demo'))

WebUI.waitForElementNotPresent(findTestObject('Page_Mileapp  Request Demo/button_Request Demo'), 50)

WebUI.verifyElementNotInViewport(findTestObject('Page_Mileapp  Success/h1_Thank you for contacting us'), 50)
